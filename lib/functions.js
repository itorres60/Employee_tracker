...
class Functions {
  ...
  updateEmployeeManager(){
    ...
    function(err, results, fields) {
      ...
      inquirer.prompt([
        ...
        var manager_id = ''
        for (let i = 0; i < employeeObjArr.length; i++) {
  ...
  addDepartment(){
    inquirer.prompt([
      ...
      db.query(
        'INSERT INTO department (department_name) VALUES ("' + data.addDepartment + '");',
  ...
  removeDepartment(){
    ...
    function(err, results, fields) {
      ...
      ]).then(departmentRemove => {
        db.query(
          "DELETE FROM department WHERE department_name = '" + departmentRemove.remove + "';",
          console.log("Deparment removed")
        ); 
        setTimeout(function afterTwoSeconds() {
          console.log("\n===================================================================================================================\n")
          promptUser();
